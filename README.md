...
**Name (Team Member 1):**Austin Nguyen 
...
**As n goes to infinity, it shows as a^kW(n/b^k) + (1 - a^k)/(1-a) (for f(n) = 1), and holds true for the rest of the functions.**
...
**If c < \log_b a, then it will converge to a smaller number, while c > \log_b a will converge to a bigger number because a makes the recurrance grow by a factor of a while as b increases it reduced by logb. If they are equal, then it will not affect the function.**
